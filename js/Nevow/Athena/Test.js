...
/* TestCase and TestRunner subclass Widget which is probably bad. */
...
//Nevow.Athena.Test.TestCase = Divmod.Class.subclass('Nevow.Athena.Test.TestCase');
Nevow.Athena.Test.TestCase.methods(
	 ...
	 *
	 * Still used in many placed by Athena tests.
	 */
